<template>
    <div>
        ...
        ></menu-item>
        <menu-item
            v-if="$store.state.permissions && $store.state.permissions['App.Http.Controllers.Api.Dashboard.TicketsController']"
            :label="$t('Tickets')"
            :mobile="mobile"
        ...
        <menu-item
            v-if="$store.state.permissions && $store.state.permissions['App.Http.Controllers.Api.Dashboard.Admin.CompaniesController']"
            :label="$t('Companies')"
            :mobile="mobile"
