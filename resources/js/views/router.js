...
let routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {path: 'Tickets', component: DashboardTicketsList, meta: {middleware: 'auth', dashboard_access: true, controller: 'App.Http.Controllers.Api.Dashboard.TicketsController'}},
            {path: 'Tickets/new', component: DashboardTicketsNew, meta: {middleware: 'auth', dashboard_access: true, controller: 'App.Http.Controllers.Api.Dashboard.TicketsController'}},
            {path: 'Tickets/:uuid/manage', component: DashboardTicketsManage, meta: {middleware: 'auth', dashboard_access: true, controller: 'App.Http.Controllers.Api.Dashboard.TicketsController'}},
            ...
            {path: 'admin/Companies', component: AdminDashboardCompaniesList, meta: {middleware: 'auth', dashboard_access: true, controller: 'App.Http.Controllers.Api.Dashboard.Admin.CompaniesController'}},
            {path: 'admin/Companies/new', component: AdminDashboardCompaniesNew, meta: {middleware: 'auth', dashboard_access: true, controller: 'App.Http.Controllers.Api.Dashboard.Admin.CompaniesController'}},
            {path: 'admin/Companies/:id/edit', component: AdminDashboardCompaniesEdit, meta: {middleware: 'auth', dashboard_access: true, controller: 'App.Http.Controllers.Api.Dashboard.Admin.CompaniesController'}},
