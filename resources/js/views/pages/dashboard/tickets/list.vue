                                                            ...
                                                            <div class="col-span-3 mb-2">
                                                                ...
                                                                <div class="relative inline-flex w-full">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <option value="Companies_id">{{ $t('Companies') }}</option>
        ...
        <div class="Tickets-list">
            <div class="hidden sm:block">
                <div v-show="selectedRows.length > 0" v-on-clickaway="closeQuickActionDropdown" class="Tickets-list-toolbar">
                    ...
                    <div class="relative inline-block text-left">
                        <button class="btn hover:bg-gray-100 p-4 border-r border-gray-200 rounded-none" type="button" @click="toggleQuickActionDropdown('Companies')">
                            <svg-vue class="h-6 w-6 text-gray-700" icon="font-awesome.users-class-regular"></svg-vue>
                        </button>
                        <div v-show="quickActions.Companies" class="origin-top-right absolute left-0 mt-1 w-56 rounded-md shadow-lg">
                            <div class="rounded-md bg-white shadow-xs">
                                <div class="py-1">
                                    <template v-for="Companies in CompaniesList">
                                        <a
                                            ...
                                            href="#"
                                            role="menuitem"
                                            @click.prevent="quickAction('Companies', Companies.id)"
                                        >
                                            {{ Companies.name }}
                                        </a>
                                    </template>
            ...
            <template v-if="TicketsList.length > 0">
                <div class="sm:hidden">
                    <ul class="border-b border-gray-200 divide-y divide-gray-200">
                        <template v-for="Tickets in TicketsList">
                            <li>
                                <router-link
                                    :to="'/dashboard/Tickets/' + Tickets.uuid + '/manage'"
                                    ...
                                    <div class="flex items-center truncate space-x-3">
                                        ...
                                        <div class="whitespace-no-wrap">
                                            <div class="text-sm leading-5 text-gray-900">
                                                <template v-for="label in Tickets.labels">
                                                    <div
                                            ...
                                            <div class="text-sm leading-5 text-gray-500 w-full truncate">
                                                {{ Tickets.lastReply ? Tickets.lastReply.body : null }}
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <template v-for="Tickets in TicketsList">
                                ...
                                >
                                    <td class="px-3 py-4 whitespace-no-wrap text-center text-sm leading-5 font-medium">
                                        <input
                                            :id="'Tickets-' + Tickets.id"
                                            v-model="selectedRows"
                                            :value="Tickets.id"
                                            aria-label="Checkbox"
                                            class="form-checkbox cursor-pointer h-4 w-4 text-blue-600 transition duration-150 ease-in-out"
                                            type="checkbox"
                                            @change="selectTickets"
                                            @click.stop
                                        >
                                    </td>
                                    ...
                                    <td class="px-3 py-4 whitespace-no-wrap leading-5">
                                        <div class="text-sm leading-5 font-medium text-gray-900">
                                            {{ Tickets.status ? Tickets.status.name : $t('Unassigned') }}
                                        </div>
                                        <div class="text-sm leading-5 text-gray-500">
                                            {{ Tickets.priority ? Tickets.priority.name : $t('Unassigned') }}
                                        </div>
                                    </td>
                                    <td class="px-3 py-4 whitespace-no-wrap leading-5">
                                        <div class="text-sm leading-5 text-gray-900">
                                            {{ Tickets.agent ? Tickets.agent.name : $t('Unassigned') }}
                                        </div>
                                    </td>
                                    <td class="px-3 py-4 whitespace-no-wrap leading-5">
                                        <div class="text-sm text-gray-500">
                                            {{ Tickets.updated_at | momentFormatDateTimeAgo }}
                                        </div>
                                    </td>
                                </router-link>
                            </template>
...
export default {
    ...
    methods: {
        ...
        closeQuickActionDropdown() {
            ...
            this.quickActions.Companies = false;
        ...
        toggleQuickActionDropdown(quickAction) {
            ...
            if (quickAction === 'Companies') {
                this.quickActions.Companies = !this.quickActions.Companies;
                this.quickActions.agent = false;
                this.quickActions.label = false;
                this.quickActions.priority = false;
                this.quickActions.delete = false;
        ...
        selectTickets() {
            ...
            this.selectAll = Object.keys(this.selectedRows).length === Object.keys(this.TicketsList).length;
        },
        selectAllTickets() {
            this.selectedRows = [];
            this.closeQuickActionDropdown();
            if (this.selectAll) {
                for (let Tickets in this.TicketsList) {
                    this.selectedRows.push(this.TicketsList[Tickets].id);
                }
            }
        },
        getTickets() {
