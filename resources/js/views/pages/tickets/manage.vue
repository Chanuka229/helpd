            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="mt-10 my-6 bg-white shadow overflow-hidden sm:rounded-md">
                    ...
                    <template v-if="Tickets.TicketsReplies.length > 0">
                        <template v-for="TicketsReply in Tickets.TicketsReplies">
...
export default {
    ...
    metaInfo() {
        return {
            title: this.$i18n.t('Tickets details')
        }
    },
    data() {
        return {
    ...
    methods: {
        ...
        addReply() {
            ...
            axios.post('api/Tickets/' + self.$route.params.uuid + '/reply', self.TicketsReply).then(function (response) {
                self.$notify({
