...
class UserFilter extends ModelFilter
{
    ...
    // This will filter 'company_id' OR 'Companies'
...
> **Note:**  In the above example if you do not want `_id` dropped from the end of the input you can set `protected $drop_id = false` on your filter class.  Doing this would allow you to have a `Companies()` filter method as well as a `companyId()` filter method.
